...
> 版本 1.1 ｜ 更新 2026-09-17 ｜ 主笔 吕建江 ｜ 审核 苏哲勋
...
| 日期 | 版本 | 变更人 | 主要变更 |
|---|---|---|---|
| 2026-09-17 | 1.0 | 吕建江 | 初版（本文件此前无版本头与变更日志，本次补齐）：线的职责、目录结构、启动命令、边界、两项非功能要求的证据要求 |
| 2026-09-17 | 1.1 | 蒋励 | ① 「模型从哪来」由「待启动会定」回填为「**已裁定 A+C**」，并写清两条交付链的责任划分（数据线出文件、本线灌 `prediction` 表）；② 补版本头与变更日志 |
