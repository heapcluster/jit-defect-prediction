...
> 版本 1.1 ｜ 更新 2026-09-17 ｜ 主笔 苏哲勋 ｜ 审核 蒋励
...
| 日期 | 版本 | 变更人 | 主要变更 |
|---|---|---|---|
| 2026-09-17 | 1.0 | 苏哲勋 | 初版（本文件此前无版本头与变更日志，本次补齐）：线的职责、目录结构、网页端设置清单、工具版本约定 |
| 2026-09-17 | 1.1 | 蒋励 | ① 「三条契约的归属」由「**待启动会统一口径**」回填为「**已裁定**」：落点 `docs/contracts/`，契约一/二由蒋励主笔、契约三由吕建江主笔，本线只负责「契约怎么冻结、怎么走变更」的规则；② 补版本头与变更日志 |
