...
- [x] 1.1 逐字段核对 `docs/pages.md` 第 2–4 节字段清单与 `api-format.md` 1.3 响应，产出「页面要用但接口没有」的缺口清单，以 Issue 形式交付刘帅华
...
- [x] 5.1 导出 FastAPI `openapi.json`，与契约三 1.3 四个接口逐字段比对，列出偏离并闭环 —— **改代码不改契约**
