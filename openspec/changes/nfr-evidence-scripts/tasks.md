...
- [x] 4.3 真 `.pkl` 交付后重跑性能组，追加真模型证据 md；回填飞书《产品需求文档》第七章性能/安全实测结果（9/23 截止）
      —— 2026-09-20 重跑完成：`perf-real-2026-09-20.md`（xgb_v1，p95=21.6ms 达标）；2026-09-21 11:00 飞书第七章已回填真模型实测版（撰写人吕建江粘贴，含证据出处与复现命令引用）
